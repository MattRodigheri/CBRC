...
Set main = new BirdList : main.Load Server.MapPath("main_list51.txt"), False
Set supp = new BirdList : supp.Load Server.MapPath("supp_list51.txt"), False
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="580">
	...
	<TR>
		...
		<TD>
			...
			and accepted by the California Bird Records Committee (CBRC). All species on this list except those annoted with P, V, A or S are supported by at least one extant specimen 
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="580">
	<TR>
		...
		<TD>
			...
			<A HREF="SightRecord.doc">[&nbsp;CBRC&nbsp;Report&nbsp;Form&nbsp;]</A> <A HREF="photos/index.html">[&nbsp;Rare&nbsp;Bird&nbsp;Photos&nbsp;]</A>
