...
Set rev = new BirdList : rev.Load Server.MapPath("main_list.txt"), True
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="580">
	...
	<TR>
		...
		<TD>
			...
			occurrences per year in California over the most recent ten year period. Documentation should be sent to
			the CBRC Secretary by e-mail to <A
...
<DL>
	<DD>
	<DT><B><FONT COLOR="#000099">We also review records of the following species groups and hybrids:</FONT></B></DT>
	<DL>
		<DD>Taiga/Tundra Bean-Goose <I>Anser fabalis/serrirostris</I> <BR>
		Magnificent/Great/Lesser Frigatebird <I>Fregata magnificens/minor/ariel</I><BR>
		Masked/Nazca Booby <I>Sula dactylatra/granti</I><BR>
