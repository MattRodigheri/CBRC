...
Set main = new BirdList : main.Load Server.MapPath("main_list.txt"), False
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="580">
	...
	<TR>
		...
		<TD>
			...
			<P>A total of <%=TextNum(main.total)%> species is included on this official California checklist, <%=TextNum(main.countI)%> of which are established introductions, <%=TextNum(main.countE)%> of which has been extirpated within historical times, and one of which is in the process of being reintroduced but is not yet established. An additional <%=TextNum(supp.total)%> species have been recorded in the
			...
			fewer occurrences per year in California over the most recent ten year period. Documentation should be sent to
			Guy McCaskie, California Bird Records Committee, by e-mail to <A HREF="mailto:secretary@californiabirds.org">secretary@californiabirds.org</A>.
	...
	<TR>
		...
		<TD><B>Legend</B><BR>
			...
			* - California Bird Records Committee Review Species (<%=main.countRev%> species)<BR>
			...
			RI - Reintroduction in progress - not yet established. (<%=main.countRI%> species)<BR>
			<BR>
