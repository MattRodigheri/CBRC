...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="580">
	...
	<TR>
		...
		<TD>
			...
			<%=TextNum(main.countE)%> of which has been extirpated within historical times, and one which is in the process of being reintroduced but which is not yet established. An additional <%=TextNum(supp.total)%> species have been recorded in the
			...
			sent to Guy McCaskie, California Bird Records Committee, to <A HREF="mailto:secretary@californiabirds.org">secretary@californiabirds.org</A>).
	...
	<TR>
		...
		<TD><B>Legend</B><BR>
			...
			* - California Bird Records Committee Review Species (<%=main.countRev%> species)<BR>
			...
			RI - Reintroduction in progress - not yet established. (<%=main.countE%> species)<BR>
			<BR>
